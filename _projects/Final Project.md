...
### Visualization 1: Geopandas Plot with Matplotlib Markers 
<iframe src="{{ site.baseurl }}/assets/plots/visualization_1.html" width="100%" height="600" frameborder="0" allowfullscreen></iframe>
...
<iframe src="{{ site.baseurl }}/assets/plots/visualization_2.html" width="100%" height="600" frameborder="0" allowfullscreen></iframe>
...
### Visualization 3: Scatter Plot - Earthquake's Depth vs Magnitude 

<iframe src="{{ site.baseurl }}/assets/plots/visualization_3.html" width="100%" height="600" frameborder="0" allowfullscreen></iframe>
...
### Visualization 4: Folium Plot - Overall Earthquake locations on semi real-time global map

<iframe src="{{ site.baseurl }}/assets/plots/earthquake_map.html" width="100%" height="600" frameborder="0" allowfullscreen></iframe>
...
For further information about the data and a detailed analysis, please refer to the link below:
